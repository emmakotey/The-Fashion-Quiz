...
<!-- Mirrored from www.ansonika.com/steps/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 15:54:06 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
			...
			<div id="wizard_container">
				<form name="example-1" id="wrapped" method="POST">
					...
					<div id="middle-wizard">
						...
						<!-- What Type of Project > Web-Development ============================== -->
						...
						<div class="branch" id="Design">
							<div class="step" data-state="budget">
								...
								<div class="row">
									<div class="col-lg-4">
										<div class="item">
											<input id="branch_3_answer_1" type="checkbox" name="branch_3_answers[]" value="Web Design" class="required">
									...
									<div class="col-lg-4">
										<div class="item">
											<input id="branch_3_answer_2" name="branch_3_answers[]" type="checkbox" value="Print Design" class="required">
									...
									<div class="col-lg-4">
										<div class="item">
											<input id="branch_3_answer_3" name="branch_3_answers[]" type="checkbox" value="Logo Design" class="required">
	...
	<footer>
		<div class="container clearfix">
			<ul>
				<li><a href="index-2.html" class="animated_link">Multiple Branch</a></li>
				<li><a href="index1.php" class="animated_link active">Single Branch</a></li>
				<li><a href="index.php" class="animated_link">Without Branch</a></li>
				<li><a href="index-5.html" class="animated_link">Images Version</a></li>
				<li><a href="index-6.html" class="animated_link">Multiple Branch + FileUpload</a></li>
				<li><a href="https://1.envato.market/e2ryr" class="animated_link" target="_parent"><strong>Purchase this Template</strong></a></li>
			</ul>
			<p>© 2021 Steps</p>
		</div>
	</footer>
