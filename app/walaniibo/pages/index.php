...
<head>
    ...
    <body id="body">
            ...
            <div class="main-icon-menu">
                ...
                <div class="pro-metrica-end">
                    <a href="#" class="profile">
                        <img src="../assets/images/Stickey-Logo.png" alt="profile-user" class="rounded-circle thumb-sm">
                    </a>
            ...
            <div class="main-menu-inner">
                ...
                <div class="topbar-left">
                    <a href="index.php" class="logo">
                        <span>
                            <img src="../assets/images/logo.png" alt="logo-large" class="logo-lg logo-dark" width=50px height=100px>
                            <img src="../assets/images/logo.png" alt="logo-large" class="logo-lg logo-light" height=50px>
                        </span>
                    </a><!--end logo-->
                </div><!--end topbar-left-->
                <!--end logo-->
                <div class="menu-body navbar-vertical tab-content" data-simplebar>
                    <div id="MetricaDashboard" class="main-icon-menu-pane tab-pane" role="tabpanel"
                        ...
                        <div class="title-box">
                            <a href="index.php"><h6 class="menu-title">Dashboard</h6></a>
                        </div>

                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?clients">Client List</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="index.php?fquizr">Quiz Result</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="#0">CRM</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="#0">Project</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="#0">Ecommerce</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="#0">Helpdesk</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                                <a class="nav-link" href="#0">Analysis Area</a>
                            </li><!--end nav-item-->
                        </ul><!--end nav-->
                    </div><!-- end Dashboards -->
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    ...
                                    <div class="collapse " id="sidebarAnalytics">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a href="index.php?addnewcat" class="nav-link ">Add New</a>
                                            </li><!--end nav-item-->
                                            <li class="nav-item">
                                                <a href="index.php?viewcat" class="nav-link ">View All</a>
                                            </li><!--end nav-item-->
                                        </ul><!--end nav-->
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse " id="sidebarCrypto">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                <a class="nav-link" href="index.php?addresult">Add Results</a>
                                            </li><!--end nav-item-->
                                            <li class="nav-item">
                                                <a class="nav-link" href="index.php?viewresult">View Results</a>
                                            </li><!--end nav-item-->
                                            <!--end nav-item-->
                                        </ul><!--end nav-->
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse " id="sidebarHelpdesk">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="helpdesk-agents.html">Users</a>
                                            </li><!--end nav-item-->
                                        </ul><!--end nav-->
                    ...
                    <div id="MetricaAuthentication" class="main-icon-menu-pane tab-pane" role="tabpanel"
                        ...
                        <div class="title-box">
                            <h6 class="menu-title">Seetings</h6>
                        </div>
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="auth-login.html">Quiz Cate</a>
                            </li><!--end nav-item-->
                            <li class="nav-item">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button"
                            ...
                            <div class="d-flex align-items-center">
                                <img src="../assets/images/logo.png" alt="profile-user" class="rounded-circle me-2 thumb-sm" />
                                <div>
                                    
                                    <span class="d-none d-md-block fw-semibold font-12"><?php echo $_SESSION['USER_ADMIN_ID'];?> <i
        ...
        <div class="page-wrapper">
                            ...
                            <div class="card overflow-hidden">                                
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <?php 
                        require_once ("../config/config.php");
                $query = "Select qid, COUNT(qid) From tblquiz";
                $result = mysqli_query($login, $query) or die (mysql_error());   
                while ($row=mysqli_fetch_array($result)){
                    //echo "<h2> ". $row['COUNT(qid)'] ." </h2>";
                    echo " <span class='h4 fw-bold'>". $row['COUNT(qid)'] ."</span>";
                }
                
                ?>                                                                     
                                          
                                            <h6 class="text-uppercase text-muted mt-2 m-0 font-11">Quizzes</h6>                
                                        </div><!--end col-->
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">                                                                        
                                           <?php 
                        require_once ("../config/config.php");
                $query = "Select id, COUNT(id) From clienttbl";
                $result = mysqli_query($login, $query) or die (mysql_error());   
                while ($row=mysqli_fetch_array($result)){
                    //echo "<h2> ". $row['COUNT(qid)'] ." </h2>";
                    echo " <span class='h4 fw-bold'>". $row['COUNT(id)'] ."</span>";
                }
                
                ?>                             
                                            <h6 class="text-uppercase text-muted mt-2 m-0 font-11">All Clients </h6>                
                                        </div><!--end col-->
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">                                                                        
                                            ...
                                            <h6 class="text-uppercase text-muted mt-2 m-0 font-11">Supports</h6>                
                                        </div><!--end col-->
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">                                                                        
                                            ...
                                            <h6 class="text-uppercase text-muted mt-2 m-0 font-11">Admininistrators</h6>                
                                        </div><!--end col-->
                                        <div class="col-auto">
                        ...
                        <div class="col-12 col-md-4 col-lg-2"> 
                            <div class="card overflow-hidden">                                
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">                                                                        
                                            <span class="h4 fw-bold">75</span>      
                                            <h6 class="text-uppercase text-muted mt-2 m-0 font-11">Numbers</h6>                
                                        </div><!--end col-->
                                        <div class="col-auto">
           ...
           else if(isset($_REQUEST['editcat'])){
            include('editcate.php');
           }

           else if (isset($_REQUEST['deletecat'])){
...
//view clients list
           ...
           //female quize result
           else if (isset($_REQUEST['fquizr'])){
            include('fquize_result.php');
           }
           //adding result and view results modle
           else if(isset($_REQUEST['addresult'])){
            include ('addresult.php');
           }
           else if(isset($_REQUEST['savequizresul'])){
            include('addresult.php');
           }
           else if(isset($_REQUEST['viewresult'])){
            include('viewquizresult.php');
           }
           else if(isset($_REQUEST['editquizrest'])){
            include('editresult.php');
           }
           else if(isset($_REQUEST['deletequizrest'])){
            include('deletequizresult.php');
           }
           ...
           ?>
                ...
                <footer class="footer text-center text-sm-start">
                    ...
                    </script> WALANII <span class="text-muted d-none d-sm-inline-block float-end">Developed by: <i
                            class="#"></i>The Fashion Quiz</span>
                </footer>
                <!-- end Footer -->                
                <!--end footer-->
            </div>
        ...
        <script src="../assets/js/pages/hospital-index.init.js"></script>
